                            ...
                            <div class="bg-secondary-soft px-4 py-5 rounded">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input name="name_document" type="text" class="form-control" placeholder=""
                                            aria-label="Name">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Link Document</label>
                                        <input name="link_document" type="text" class="form-control" placeholder=""
                                            aria-label="Name">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Type</label>
                                        <input name="type" type="number" class="form-control" placeholder=""
                                            aria-label="Name">
                                    </div>
                                </div>
                            </div> <!-- Row END -->
